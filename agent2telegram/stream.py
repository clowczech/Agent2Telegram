...
class StreamBridge(AttachBridge):
    ...
    # Its own queue alongside the configs and a different lifecycle — the durable outbox is for
    # attach mode only for now, so stream isn't changed without its own spec and tests.
